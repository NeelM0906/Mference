...
struct GroupedAttentionIdentityTests {
    ...
    @Test func geometrySelectsTheGroupedKernelOnlyForGemmaFullAttention() {
    ...
    private func compare(seqLen: Int, pattern: String, chunkLength: Int? = nil,
        ...
        for i in 0..<(seqLen * 1024) {
            ...
            case "lateMaximum":
                ...
                kp[i] = (i / 1024) % 17 == 16 ? Float16(2) : Float16(-2)
        ...
        let dispatchValues: [Int] = [512, 16, 2, seqLen, 0, chunk, 16]
        ...
        for repetition in 0..<2 {
            ...
            for index in 0..<4 {
                ...
                #expect(changed == 0, """
                    length=\(seqLen) pattern=\(pattern) seed=\(seed) repetition=\(repetition) \
