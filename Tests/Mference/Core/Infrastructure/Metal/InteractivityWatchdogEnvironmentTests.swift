...
/// The AGX driver reads `AGX_RELAX_CDM_CTXSTORE_TIMEOUT` once, at the first
/// Metal device creation in the process, so these tests observe the variable
/// `makeSystemDefaultDevice` leaves behind rather than the driver's reaction.
