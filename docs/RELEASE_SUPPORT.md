...
| `glm53flash` | Advanced qualification candidate for this update | 180.84 GB | Pinned install completed and verified; real validation of the new prefill kernels pending. Resident target is the 256 GiB host; streamed synthetic tests do not certify a smaller Mac. [Evidence](families/GLM53_FLASH.md). |
